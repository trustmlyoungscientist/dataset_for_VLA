...
def main():
    ...
    parser.add_argument(
        "--demo-file", 
        default="/home/whr/LIBERO/libero/libero-master/backdoored_demonstration_hdf5/robosuite_ln_libero_floor_manipulation_1746698183_4783623_pick_the_tomato_sauce_and_place_it_in_the_basket/demo.hdf5"
    )
    parser.add_argument(
        "--use-actions",
        action="store_true",
